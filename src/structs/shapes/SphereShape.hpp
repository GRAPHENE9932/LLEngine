...
public:
    ...
    SphereShape(SphereShape&& sphere_shape) : axis(sphere_shape.axis), Shape(std::move(sphere_shape)) {}
    SphereShape(const glm::vec3& axis) : axis(axis) {}
    SphereShape(float radius) noexcept : axis(radius) {}
