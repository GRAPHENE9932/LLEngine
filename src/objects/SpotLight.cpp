...
void SpotLight::set_uniforms(const SpotLight::Uniforms& uniforms, const bool overlay) const {
    glUniform3fv(uniforms.position_id, 1, overlay ? &overlay_position[0] : &position[0]);
    glUniform3fv(uniforms.direction_id, 1, overlay ? &overlay_direction[0] : &direction[0]);
